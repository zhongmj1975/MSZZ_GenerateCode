using KingWin.Entities;
using KingWin.Utilities;
...
public class DbContext<T> where T : class, new()
{
   ...
   public SimpleClient<LotteryData> LotteryDataDb { get { return new SimpleClient<LotteryData>(Db); } }//用来处理T_RolePermission表的常用操作
