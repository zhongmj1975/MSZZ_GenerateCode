...
{
    [ELinkTable("OrderFangWeiCodeRule")]
    public class OrderFangWeiCodeRule : BaseClass
    {
        [ELinkColumn(ColumnName = "OrderID",  ColumnDescription ="玩法编号", Length = 32, ColumnDataType = "bigint")]
